    ...
    <div className="px-[5%]">
      ...
      <div className="max-w-6xl flex flex-col  relative left-1/2 -translate-x-1/2">
        ...
        <button
          ...
          className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl bg-black  md:px-3 md:py-5 p-3  text-white  rounded-lg font-uber-medium w-full my-6 lg:mt-95 xl:mt-15"
        >
          Avanti
        </button>
      </div>
